...
<html lang="en">
  <head>
    ...
    <link id="pagestyle" href="{{ asset('css/dashboard/material-dashboard.css') }}" rel="stylesheet" />
  ...
  <body class="g-sidenav-show  bg-gray-100">
    ...
    <div class="sidenav-header">
        ...
        <!-- <img src="./assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo"> We can place a icon here -->
        <span class="ms-1 font-weight-bold text-white">Abigales Book Corner</span>
        </a>
    </div>
  ...
  <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link text-white " href="{{ route('createBlog') }}">
                <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
...
<div class="row">
  ...
  <div class="card-header p-3 pt-2">
    ...
    <div class="text-end pt-1">
      <p class="text-sm mb-0 text-capitalize">Blog Admin</p>
      <h4 class="mb-0"><!-- This will be filled with numbers of blogs --> </h4>
    </div>
  </div>
